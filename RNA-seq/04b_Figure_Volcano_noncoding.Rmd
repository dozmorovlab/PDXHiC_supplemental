...
fileNameOut1 <- file.path(data_dir, "results/Figure_Volcano_noncoding.svg")
...
mtx <- mtx[mtx$biotype == "lncRNA", ] # filter to contain only lncRNAs
...
# DN_described = c("NFE4", "APCDD1L-DT", "LINC01615", "FIRRE", "TP53TG1", "LINC01133", "MIR100HG" )
# top20DN <- res %>% 
#   filter(symbol %in% DN_described)
